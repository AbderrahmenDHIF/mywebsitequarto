...
Dans cette partie, nous allons explorer comment implémenter la segmentation RFM en utilisant R et Python, en nous basant sur le jeu de données 'Online Retail II' disponible sur Kaggle.
...
```{python}
import pandas as pd
data = pd.read_excel("data/nline_retail_II.xlsx")
