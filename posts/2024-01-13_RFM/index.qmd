...
annotate("label",x=35,y=100,label="OCCASIONNEL",color="#63A10F",size=3,font="face")+
annotate("segment", x = 3.3, xend = 3.3, y = 0, yend = 200,lty=2 ,color="#D00000",size=1)+
annotate("label",x=2,y=400,label="PETIT",color="#D19403",size=3,font="face")+
...
La segmentation RFM nous permet de cibler plus efficacement les clients, en adaptant des actions marketing spécifiques à leurs comportements d'achat.
