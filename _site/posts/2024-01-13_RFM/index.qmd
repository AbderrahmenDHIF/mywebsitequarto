...
[lien](https://www.kaggle.com/datasets/vijayuv/onlineretail)
...
from plotnine import ggplot, geom_point, aes, geom_hline, annotate, theme_bw, labs
...
data_filtered = data_fideles_km_filtered[data_fideles_km_filtered['Frequence'] < 20]

# Création du graphique
(ggplot(data_filtered, aes(x='Frequence', y='Recence', color='segment')) + 
 geom_point(alpha=0.3) +  
 geom_hline(yintercept=30.5*6, linetype='dashed', color="#D00000", size=1) +  
 annotate("text", x=15, y=32*6, label="Seuil Récence", color="#BEBDBD") + 
 annotate("text", x=15, y=29*6, label="6 mois", color="#848484") +  
 annotate("text", x=15, y=300, label="ENDORMIS", color="#AD0BA5", size=13, fontstyle='italic') +  
 theme_bw() +  
 labs(title="Analyse RF des clients fidèles", x="Fréquence", y="Récence")  
).draw()
